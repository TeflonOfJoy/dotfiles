...
typedef struct contact {
   char* name;     // assumiamo che questo campo contenga una stringa valida, non nulla
   char* surname;  // assumiamo che questo campo contenga una stringa valida, non nulla
   char* mobile;
   char* url;
} Contact, *ContactPtr;
